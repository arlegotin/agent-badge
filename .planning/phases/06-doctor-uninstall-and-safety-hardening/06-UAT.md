...
number: 2
name: Doctor Command Surface
expected: |
  Running `agent-badge doctor` should print the diagnostic check list with pass/warn/fail style statuses and actionable recovery guidance for any failing checks.
