...
|-----------|----------|-----------|-------------|------------|--------|
| T-26-01-01 | Tampering | `packages/core/src/init/runtime-wiring.ts` | mitigate | Open. [runtime-wiring.ts](/Volumes/git/legotin/agent-badge/packages/core/src/init/runtime-wiring.ts#L499) removes `@legotin/agent-badge` whenever the version string looks managed, but it does not prove the dependency is tool-owned before pruning it. [runtime-wiring.test.ts](/Volumes/git/legotin/agent-badge/packages/core/src/init/runtime-wiring.test.ts#L146) only proves removal, and [26-REVIEW.md](/Volumes/git/legotin/agent-badge/.planning/phases/26-minimal-repo-scaffold-and-init-rewire/26-REVIEW.md#L59) documents the user-owned dependency-loss case. | open |
...
| T-26-02-02 | Tampering | `packages/agent-badge/src/commands/init.test.ts`, `packages/core/src/init/runtime-wiring.test.ts` | mitigate | Open. [init.test.ts](/Volumes/git/legotin/agent-badge/packages/agent-badge/src/commands/init.test.ts#L495) and [runtime-wiring.test.ts](/Volumes/git/legotin/agent-badge/packages/core/src/init/runtime-wiring.test.ts#L146) prove idempotent README, hook, and gitignore behavior, but they do not prove preservation of a user-owned `@legotin/agent-badge` dependency when that value matches the cleanup heuristic. [26-REVIEW.md](/Volumes/git/legotin/agent-badge/.planning/phases/26-minimal-repo-scaffold-and-init-rewire/26-REVIEW.md#L59) identifies the missing case directly. | open |
...
**Approval:** blocked 2026-04-09 — open tampering threats remain
