...
- [ ] **REL-07**: Maintainer can verify live npm registry state for `agent-badge`, `create-agent-badge`, and `@agent-badge/core` immediately before publish, including whether the planned package names and ownership state are safe to use.
